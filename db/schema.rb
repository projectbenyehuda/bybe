...
ActiveRecord::Schema[8.1].define(version: 2026_07_15_091952) do
  ...
  create_table "lex_person_work_coauthors", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "lex_entry_id"
    ...
    t.integer "role"
    t.datetime "updated_at", null: false
    t.index ["lex_entry_id"], name: "index_lex_person_work_coauthors_on_lex_entry_id"
    t.index ["lex_person_work_id"], name: "index_lex_person_work_coauthors_on_lex_person_work_id"
  end
  ...
  add_foreign_key "lex_person_work_coauthors", "lex_entries"
  add_foreign_key "lex_person_work_coauthors", "lex_person_works"
