...
# Verifies that images referenced in a Manifestation's markdown are embedded
# in the generated PDF (not cut off or missing).
#
...
#   the full MakeFreshDownloadable HTML-transformation pipeline.
RSpec.describe 'PDF image generation', type: :system do
  ...
  before do
    ...
    # Attach the image to the manifestation
  ...
  it 'embeds the image without cutting off its width at the page boundary' do
